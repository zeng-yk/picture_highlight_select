...
class ImageProcessor(QMainWindow):
    ...
    def initUI(self):
        ...
        # self.load_button.setMinimumSize(300, 150)
        self.load_button.setMaximumSize(300, 50)
        ...
        threshold_group.setMaximumSize(300,300)
        ...
        morph_group.setMaximumSize(300,300)
